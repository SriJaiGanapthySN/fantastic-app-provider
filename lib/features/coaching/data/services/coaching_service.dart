...
class CoachingService {
  ...
  Future<Map<String, dynamic>?> getCoachingById(String objectId) async {
    try {
      AppLogger.i('CoachingService: Searching for coaching with ID: $objectId');
      ...
      if (docSnapshot.exists) {
        ...
        AppLogger.w('CoachingService: Coaching not found with ID: $objectId');
        return null;
      }
    } catch (e) {
      AppLogger.e('CoachingService: Error getting coaching by ID: $e');
      return null;
    }
  }
}
