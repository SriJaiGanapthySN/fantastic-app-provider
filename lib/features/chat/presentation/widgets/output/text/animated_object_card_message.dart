...
class AnimatedObjectCardMessage extends StatefulWidget {
  final bool isQuestion;
  final Function()? onAnimationComplete;

  const AnimatedObjectCardMessage({
    Key? key,
  ...
  @override
  State<AnimatedObjectCardMessage> createState() =>
      _AnimatedObjectCardMessageState();
}

class _AnimatedObjectCardMessageState extends State<AnimatedObjectCardMessage>
      ...
      children: [
        ClipRRect(
          borderRadius: BorderRadius.circular(
              getResponsiveWidth(context, 0.032)), // ~12 on 375 width
          child: AnimatedOpacity(
            ...
            child: Image.asset(
              ...
              height:
                  getResponsiveHeight(context, 0.2), // ~200px on 1000px height
              fit: BoxFit.cover,
            ),
          ),
        ),
