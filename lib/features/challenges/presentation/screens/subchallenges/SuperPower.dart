import 'package:fantastic_app_riverpod/features/challenges/presentation/screens/subchallenges/MediatatingPage.dart';
import 'package:fantastic_app_riverpod/features/challenges/presentation/screens/subchallenges/SuperPowerList.dart';
import 'package:flutter/material.dart';
import '../../../../onboarding/presentation/Widgets/imageCard1.dart';
                      ...
                      children: [
                        ...
                        FloatingActionButton(
                          onPressed: () {
                            ...
                            _showSuperpowerDetailDialog(
                                context, item); // ...and open the next one.
                          },
                          backgroundColor: nextButtonColor,
                          foregroundColor: Colors.white,
                          elevation: 2.0,
                          child: const Icon(
                              Icons.arrow_forward), // Always a forward arrow
                        ),
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  ...
                  textAlign: TextAlign.center,
                  style: const TextStyle(
                      color: secondaryTextColor, fontSize: 15.5, height: 1.4),
                ),
                ...
                Image.asset(
                  ...
                  height: 100,
                  errorBuilder: (context, error, stackTrace) =>
                      const Icon(Icons.extension, size: 80, color: Colors.grey),
                ),
              ...
              child: ElevatedButton(
                onPressed: () {
                  Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => MeditationActionScreen(
