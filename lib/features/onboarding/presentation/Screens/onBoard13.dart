...
class _OnBoard13State extends ConsumerState<OnBoard13> {
  ...
  void handleTap(String text) async {
    ...
    Navigator.pushReplacement(
      context,
      MaterialPageRoute(
          builder: (context) => OnBoard14()), // Replace with your next screen
    );
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      body: Stack(
        ...
        children: [
          Image.asset(
            'assets/images/onboardingImages/a74241076f85933537db177f5c72e99c_img_enchant_affirmation_build_confidence_big_img_opt.jpg',
            fit: BoxFit.cover,
          ),
          Container(
