import 'package:fantastic_app_riverpod/features/challenges/presentation/screens/subchallenges/ChallengeName.dart';
...
class _ChallengeTimeScreenState extends State<ChallengeTimeScreen> {
  ...
  Future<void> _selectOtherTime(BuildContext context) async {
    final TimeOfDay? pickedTime = await showTimePicker(
      ...
      initialTime: _customTime ??
          const TimeOfDay(hour: 9, minute: 0), // Start with custom or default
          ...
          data: ThemeData.light().copyWith(
            ...
            textButtonTheme: TextButtonThemeData(
              style: TextButton.styleFrom(
                foregroundColor:
                    const Color(0xFF00796B), // Teal for button text
              ),
            ),
    ...
    if (pickedTime != null) {
      setState(() {
        ...
        _selectedOption =
            TimeOption.other; // Automatically select "Other" after picking
      });
    }
  }
  ...
  Widget _buildTimeOptionWidget(TimeOption option) {
    ...
    TimeOfDay? timeToShow =
        (option == TimeOption.other) ? _customTime : _predefinedTimes[option];
    String displayString;
    bool isRecommendedOption = option ==
        TimeOption.recommended; // Check if it's the recommended *option*

    // Determine the text to display
    if (option == TimeOption.other) {
      displayString =
          _customTime != null ? _formatTime(_customTime!) : "Other time";
    } else {
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        padding: const EdgeInsets.symmetric(
            vertical: 18.0, horizontal: 16.0), // Consistent padding
        ...
        child: Column(
          ...
          children: [
            ...
            if (isRecommendedOption && isSelected)
              const SizedBox(height: 4), // Spacing only if label shown
  ...
  Widget build(BuildContext context) {
    ...
    TimeOfDay finalSelectedTime = (_selectedOption == TimeOption.other &&
            _customTime != null)
        ? _customTime!
        : _predefinedTimes[
            _selectedOption]!; // Assumes non-other options always have a time
    ...
    return Scaffold(
      ...
      body: Stack(
        // Use Stack for background image and positioned button
        children: [
            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const SizedBox(
                      height:
                          20), // Extra space at the bottom before button area
                ],
              ),
            ),
          ),
              ...
              child: ElevatedButton(
                ...
                onPressed: () {
                  Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => NameChallengeScreen(
