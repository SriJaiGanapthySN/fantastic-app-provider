...
import 'package:fantastic_app_riverpod/features/discover/presentation/widgets/addDiscoveryTile.dart';
...
class Discoverstrip extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    AppLogger.i('Discoverstrip: Building with ${currentData.length} items');
