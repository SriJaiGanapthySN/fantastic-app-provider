...
class AdvancedSettingsPage extends StatefulWidget {
  ...
  const AdvancedSettingsPage({Key? key, this.selectedTime = '2am (next day)'})
      : super(key: key);
                  ...
                  child: Row(
                    ...
                    children: const [
                      Icon(Icons.change_history,
                          color: Colors.greenAccent, size: 32), // Triangle
                      SizedBox(width: 12),
                      Icon(Icons.circle,
                          color: Colors.pinkAccent, size: 32), // Circle
                      SizedBox(width: 12),
                      Icon(Icons.door_front_door,
                          color: Colors.pink, size: 32), // Door
                    ],
                  ),
                ),
              ),
