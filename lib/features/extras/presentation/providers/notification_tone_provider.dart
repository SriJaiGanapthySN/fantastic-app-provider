...
final notificationTonesProvider = StateNotifierProvider<
    NotificationTonesNotifier, AsyncValue<List<NotificationTone>>>((ref) {
  return NotificationTonesNotifier(ref);
});

class NotificationTonesNotifier
    extends StateNotifier<AsyncValue<List<NotificationTone>>> {
  final Ref ref;
