...
import '../../data/models/notification_tone.dart';

class NotificationToneScreen extends ConsumerStatefulWidget {
  const NotificationToneScreen({Key? key}) : super(key: key);

  @override
  ConsumerState<NotificationToneScreen> createState() =>
      _NotificationToneScreenState();
}

class _NotificationToneScreenState
    extends ConsumerState<NotificationToneScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
            ...
            builder: (context, ref, child) {
              ...
              return Switch(
                ...
                onChanged: (value) {
                  ...
                  ref
                      .read(notificationTonesProvider.notifier)
      ...
      body: notificationTonesState.when(
        ...
        data: (tones) {
          final categories =
              ref.read(notificationTonesProvider.notifier).getCategories();

          return ListView.builder(
            itemCount: categories.length,
            itemBuilder: (context, index) {
              final category = categories[index];
              final categoryTones = ref
                  .read(notificationTonesProvider.notifier)
