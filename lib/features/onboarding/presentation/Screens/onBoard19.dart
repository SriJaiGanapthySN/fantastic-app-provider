...
class _OnBoard19State extends ConsumerState<OnBoard19> {
  ...
  void handleTap(String text) async {
    ...
    Navigator.pushReplacement(
      ...
      MaterialPageRoute(
          builder: (context) =>
              const OnBoard20()), // Replace with your next screen
    );
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      body: Stack(
        ...
        children: [
          Image.asset(
            'assets/images/onboardingImages/f682d348d09fd5f7994becc03d8870d4_img_enchant_affirmation_build_confidence_inner_step.jpg',
            fit: BoxFit.cover,
          ),
          Container(
