...
import 'package:fantastic_app_riverpod/features/coaching/data/models/skill.dart'; // Your Skill model
import 'package:fantastic_app_riverpod/features/journeys/data/models/skillTrack.dart'; // Your skillTrack model
...
import 'package:fantastic_app_riverpod/features/journeys/data/services/journey_service.dart';
...
class AppColors {
  ...
  static const Color lightTextColor =
      Color(0xFF8A8A8A); // Lighter grey for date/time
  static const Color cardBackground = Colors.white;
  static const Color pageBackground =
      Color(0xFFF5F5F5); // Or a darker color if image is primary bg
  static const Color flourishColor =
      Color(0xFF275D7A); // Dark blue flourish color
...
class _JourneyRevealType1State extends State<JourneyRevealType1> {
  ...
  static const String _flourishAssetPath =
      'assets/images/decorative_flourish.png'; // Ensure this asset exists
  ...
  Future<void> _loadContent() async {
    ...
    final String? pagedContentJson =
        widget.letterData['pagedContent'] as String?;
    ...
    if (contentUrl != null && contentUrl.isNotEmpty) {
      try {
        ...
        if (response.statusCode == 200) {
          ...
          fetchedHtml =
              fetchedHtml.replaceAll('{{name}}', _userName.toLowerCase());
          if (mounted) {
            setState(() {
  ...
  void _tryPagedContentFallback(String? pagedContentJson) {
    ...
    if (sb.isNotEmpty) {
      ...
      if (mounted) {
        setState(() {
          _htmlContent =
              "<p>Dear $_userName,</p><p>Content could not be loaded. Please try again later.</p>";
          _isLoading = false;
        });
      }
    }
  ...
  Widget build(BuildContext context) {
    final String headlineImageUrl =
        widget.letterData['headlineImageUrl'] as String? ?? '';
    final String letterNumberText =
        "Letter no. ${widget.letterData['position'] ?? 'N/A'}";
    final String displayContentTitle =
        widget.letterData['contentTitle'] as String? ?? widget.skill.title;
    final String dateText = _formatDate(widget.letterData['createdAt']);
    final String readingTime =
        "${widget.letterData['contentReadingTime'] ?? 'N/A'}";
          ...
          SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                // --- Image Area ---
                SizedBox(
                  // Define a height for the image area
                      ...
                      Positioned(
                        ...
                        child: IconButton(
                          icon: const Icon(Icons.arrow_back,
                              color: AppColors.imageOverlayText, size: 28),
                          ...
                          children: [
                            IconButton(
                              icon: const Icon(Icons.share_outlined,
                                  color: AppColors.imageOverlayText, size: 24),
                            ...
                            IconButton(
                              icon: const Icon(Icons.more_vert,
                                  color: AppColors.imageOverlayText, size: 26),
                ...
                Container(
                  ...
                  child: Padding(
                    padding: const EdgeInsets.fromLTRB(
                        24.0, 24.0, 24.0, 24.0), // Reduced bottom for SizedBox
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        Center(
            ...
            child: AnimatedSlide(
              ...
              child: AnimatedOpacity(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    color: AppColors.cardBackground
                        .withOpacity(0.98), // Solid or slightly transparent
