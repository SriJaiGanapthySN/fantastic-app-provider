...
import '../../../../ritual/data/services/task_services.dart';
import '../../../../journeys/data/services/journey_service.dart';
import '../../../../coaching/data/services/coaching_service.dart';
import '../../../../challenges/data/services/challenges_service.dart';
...
class ContentCardService {
  ...
  static Future<ContentCardData?> _getHabitContent(String objectId) async {
    try {
      ...
      AppLogger.e('ContentCardService: Error getting habit: $e');
      return null;
    }
  }
  ...
  static Future<ContentCardData?> _getJourneyContent(String objectId) async {
    try {
      ...
      AppLogger.e('ContentCardService: Error getting journey: $e');
      return null;
    }
  }
  ...
  static Future<ContentCardData?> _getCoachingContent(String objectId) async {
    try {
      ...
      AppLogger.e('ContentCardService: Error getting coaching: $e');
      return null;
    }
  }
  ...
  static Future<ContentCardData?> _getChallengeContent(String objectId) async {
    try {
      ...
      AppLogger.e('ContentCardService: Error getting challenge: $e');
      return null;
    }
  }
}
