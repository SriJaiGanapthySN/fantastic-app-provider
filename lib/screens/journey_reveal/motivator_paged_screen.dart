...
class _MotivatorPagedScreenState extends ConsumerState<MotivatorPagedScreen> {
  ...
  void initState() {
    ...
    final pagedContent = widget.motivatorData['pagedContent'];
    if (pagedContent is Map && pagedContent['pages'] is List) {
      _pages = pagedContent['pages'];
    } else {
      _pages = [];
    }
                ...
                child: SingleChildScrollView(
                  child: Column(
                    ...
                    children: [
                      ...
                      // Show parsed HTML content from contentUrl
                      if (_isLoadingHtml)
                        const Padding(
  ...
  Widget _buildPageContent(Map<String, dynamic> pageData) {
    final String htmlText = (pageData['text'] as String? ?? '');
